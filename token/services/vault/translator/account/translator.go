...
func NewTranslator(txID string, rwSet translator.RWSet, namespace string) *Translator {
	w := &Translator{
		RWSet:           rwSet,
		TxID:            txID,
		counter:         0,
...
func (w *Translator) checkIssue(issue translator.IssueAction) error {
...
func (w *Translator) checkTransfer(t translator.TransferAction) error {
...
func (w *Translator) commitSetupAction(setup translator.SetupAction) error {
...
func (w *Translator) commitIssueAction(issueAction translator.IssueAction) error {
	base := w.counter
...
func (w *Translator) commitTransferAction(transferAction translator.TransferAction) error {
	base := w.counter
